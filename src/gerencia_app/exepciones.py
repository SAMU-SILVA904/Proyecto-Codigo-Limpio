...
class CantidadInvalidaError(TiendaError):
    def __init__(self, cantidad: float | int) -> None:
        ...
        super().__init__(f"La cantidad '{cantidad}' es inválida. Debe ser un número positivo.")
...
class IdUsuarioInvalidoError(UsuarioError):
    def __init__(self, id_usuario: int) -> None:
        ...
        super().__init__(f"El ID de usuario '{id_usuario}' es inválido. Debe ser un número entero positivo.")
...
class NombreUsuarioInvalidoError(UsuarioError):
    def __init__(self, nombre_usuario: str) -> None:
        ...
        super().__init__(f"El nombre de usuario '{nombre_usuario}' es inválido. No puede estar vacío o contener solo espacios.")
...
class NombreProductoInvalidoError(ProductoError):
    def __init__(self, nombre_producto: str) -> None:
        ...
        super().__init__(f"El nombre del producto '{nombre_producto}' es inválido. No puede estar vacío o contener solo espacios.")

class IdProductoInvalidoError(ProductoError):
    def __init__(self, id_producto: int) -> None:
        self.id_producto = id_producto
        super().__init__(f"El ID de producto '{id_producto}' es inválido. Debe ser un número entero positivo.")
...
class StockInsuficienteError(CarritoError):
    def __init__(self, producto_id: int, stock_disponible: int) -> None:
        ...
        super().__init__(f"Stock insuficiente para el producto con id '{producto_id}'. Stock disponible: {stock_disponible}")
